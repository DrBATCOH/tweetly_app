"""
Django settings for tweetly_app project.
...
from tweetly_app.logger_formater import ContextFormatter
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                'core.presentation.views.possible_followers'
            ],
        },
    },
]

WSGI_APPLICATION = "tweetly_app.wsgi.application"
